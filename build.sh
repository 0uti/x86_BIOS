/C/Programme/NASM/nasm.exe -O9 -f bin -o FILL16.bin -l FILL16.lst FILL16.asm
/C/Programme/NASM/nasm.exe -O9 -f bin -o FILL24.bin -l FILL24.lst FILL24.asm
/C/Programme/NASM/nasm.exe -O9 -f bin -o FILL32.bin -l FILL32.lst FILL32.asm
